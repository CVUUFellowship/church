<?php
// application/models/AVPeopleMapper.php
     
    class Application_Model_AVPeopleMapper
    {
        protected $_dbTable;
        ...
        public function getDbTable()
        {
            if (null === $this->_dbTable) {
                $this->setDbTable('Application_Model_DbTable_AVPeople');
            }
        ...
        public function save(Application_Model_AVPeople $avp, $new = 'old')
        {
            $data = array(
                'PeopleID'  => $avp->getID(),
            );
...
//echo($sql->__toString()); exit;
            ...
            foreach ($resultSet as $row) {
                $entry = new Application_Model_AVPeople();
