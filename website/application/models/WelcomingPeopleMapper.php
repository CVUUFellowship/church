<?php
// application/models/WelcomingPeopleMapper.php
     
    class Application_Model_WelcomingPeopleMapper
    {
        protected $_dbTable;
        ...
        public function getDbTable()
        {
            if (null === $this->_dbTable) {
                $this->setDbTable('Application_Model_DbTable_WelcomingPeople');
            }

            return $this->_dbTable;
        }
     
        public function save(Application_Model_WelcomingPeople $wp, $new = 'old')
        {
            $data = array(
                'PeopleID'  => $wp->getID(),
            );
...
//echo($sql->__toString()); exit;
            ...
            foreach ($resultSet as $row) {
                $entry = new Application_Model_WelcomingPeople();
