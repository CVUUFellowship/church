<?php
// application/models/AVStatusMapper.php
     
    class Application_Model_AVStatusMapper
    {
        protected $_dbTable;
        ...
        public function getDbTable()
        {
            if (null === $this->_dbTable) {
                $this->setDbTable('Application_Model_DbTable_AVStatus');
            }
        ...
        public function save(Application_Model_AVStatus $avstatus)
        {
            $data = array(
                'RecordID'  => $avstatus->getId(),
                'PeopleID'  => $avstatus->getPeopleid(),
                'DateID'   => $avstatus->getDateid(),
                'Early'   => $avstatus->getEarly(),
...
//echo($sql->__toString()); exit;
            ...
            foreach ($resultSet as $row) {
                $entry = new Application_Model_AVStatus();
