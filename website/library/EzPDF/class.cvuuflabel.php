...
var $ourname="MSBOA";
var $image=array('width'=>72, 'height'=>0, 'loc'=>''); //image used on nametag
...
function formatLabel($type, $names, $labelX, $labelY, $FillBlanks) {
  ...
  $root = $_SERVER["DOCUMENT_ROOT"]."/media/graphics";
...
//echo $line["x1"],' ',$line["y1"],' ',$line["x2"],' ',$line["y2"],'<BR>';
      ...
      // print the dot
      $dot=$names->HoodDot;
//echo $dot, ' ', "$root/dots/$dot.png", '<br>', "$root/graychalice.png"; exit;      
      $this->addPngFromFile("$root/dots/$dot.png",
        $this->margin_l+$labelX+200,$labelY-100,60);
			$this->ezSetY($labelY);

      // print the chalice
      $this->addPngFromFile("$root/chalice.png",
...
//echo $dot, ' ', "$root/dots/$dot.png", '<br>', "$root/graychalice.png"; exit;      
      ...
      // print the chalice
      $this->addPngFromFile("$root/graychalice.png",
        $this->margin_l+$labelX+35,$labelY-210,200);
//      $this->addPngFromFile('$root/chaliceLogo.png',
...
//echo $line["x1"],' ',$line["y1"],' ',$line["x2"],' ',$line["y2"],'<BR>';
      ...
      // print the chalice
      $this->addPngFromFile("$root/darkgraychalice.png",
