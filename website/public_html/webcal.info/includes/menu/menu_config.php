...
$menuExtras[1] =  array ('menu', 'CVUUF', '',
  array ( 
    ...
    array ( 'item', 'edit2.png', 'Request Event', '../private/calrequest.php', '' ),
    array ( 'item', 'todo.png', 'Check Approval', '../private/cal_approval.php', '' )
    )
);
$menuExtras[4] =  array ( 'menu', 'Rooms', '',
  array (
    array ( 'item', 'todo.png', 'All Rooms Availability', 'view_v.php?id=13', ''),
    array ( 'item', 'todo.png', 'Classrooms Availability', 'view_v.php?id=11', ''),
    array ( 'item', 'todo.png', 'Large Rooms Availability', 'view_v.php?id=12', ''),
    array ( 'item', 'todo.png', 'Meeting Rooms Availability', 'view_v.php?id=2', '')
     )
);
