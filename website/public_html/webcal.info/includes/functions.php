...
function display_month ( $thismonth, $thisyear, $demo = false ) {
  ...
  $login, $today, $user, $WEEK_START, $WEEKENDBG, $CVUUF_Month;
$CVUUF_Month='yes';
  $ret = '
...
function print_entry ( $event, $date ) {
  ...
  $layers, $login, $PHP_SELF, $TIME_SPACER, $user, $CVUUF_Month;
  ...
  if ( ! $event->isUntimed () ) {
    ...
    if ( $DISPLAY_END_TIMES == 'Y'  && $CVUUF_Month<>'yes')
