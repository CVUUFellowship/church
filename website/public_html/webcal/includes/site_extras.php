...
$site_extras = array (
   array (
     "Contact",         // unique name of this extra field (used in db)
     "Contact", // how this field will be described to users
     EXTRA_TEXT,  // type of field
     50,                   // width of text entry
     0,                    // height of text entry
     EXTRA_DISPLAY_ALL   //Display in all places

   ),
   array (
     "ID",         // unique name of this extra field (used in db)
     "Event Number", // how this field will be described to users
     EXTRA_TEXT,  // type of field
     5,                   // width of text entry
     0,                    // height of text entry
     EXTRA_DISPLAY_ALL   //Display in all places

   ),
   array (
     "ExtraTime",         // unique name of this extra field (used in db)
     "Setup", // how this field will be described to users
     EXTRA_TEXT,    // type of field
     5,     // href target of URL ( '', '_blank', '_top, etc )
     0,                    // height of text entry
     EXTRA_DISPLAY_ALL   //Display in all places
